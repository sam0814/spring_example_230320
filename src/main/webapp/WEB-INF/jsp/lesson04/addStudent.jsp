...
<body>
	<div class="container">
		...
		<form method="post" action="/lesson04/ex02/add_student">
			...
			<div class="form-group">
				<label for="phoneNumber"><b>폰번호</b></label> <input type="text"
					id="phoneNumber" name="phoneNumber" class="form-control col-3"
					placeholder="휴대폰 번호를 입력하세요">
			</div>
			<div class="form-group">
				<label for="email"><b>이메일</b></label> <input type="text"
					id="email" name="email" class="form-control col-3"
					placeholder="이메일을 입력하세요">
			</div>
			<div class="form-group">
				<label for="dreamJob"><b>장래희망</b></label> <input type="text"
					id="dreamJob" name="dreamJob" class="form-control col-3"
